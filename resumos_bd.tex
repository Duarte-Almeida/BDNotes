...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.4]{cap4/caminhos_transacoes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.4]{cap4/diagrama_estados_trans.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale = 0.4]{cap4/isolamento_transacoes.png}
